...
from src.models.data_classes import Colors, Dimensions  # Add Dimensions import
...
class TimeManagementApp:
    def __init__(self):
        ...
        self.window.grid_rowconfigure(0, minsize=self.dims.NAV_HEIGHT)  # Navigation
        self.window.grid_rowconfigure(1, minsize=self.dims.TOP_TASKS_HEIGHT)  # Top tasks
        self.window.grid_rowconfigure(2, minsize=self.dims.TIME_BLOCKS_HEIGHT)  # Time blocks (includes title and canvas)
        ...
        self.time_blocks.grid(row=2, column=0, sticky="nsew")  # Changed from row=2 to match configuration
